class Thing # Ultimate ancestor of all the other clases defined below
...
class Thing2 < Thing
  def initialize(aName, aDescription)
    super # Use super keyword on it's own to pass all incoming arguments to matching ancestor method
